package cn.datapilot.common.enums;
...
public enum ServerName {
     ...
     */
    FLOW_SERVER("data-pilot-flow", "数据流服务"),
    /**
     * 配置服务，页面配置处理
     */
    WEB_SERVER("data-pilot-web", "配置服务"),
    /**
     * 查询模板，对外提供查询
     */
    QUERY_SERVER("data-pilot-query", "查询服务"),
    /**
     * 告警分发，数据对齐、数据源健康检查等处理
     */
    SUPPORT_SERVER("data-pilot-support", "支持服务"),
    ;
