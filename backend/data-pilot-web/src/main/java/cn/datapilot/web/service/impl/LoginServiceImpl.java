...
import cn.datapilot.web.store.mapper.UserLoginLogMapper;
import cn.datapilot.web.store.mapper.UserWorkspaceMapper;
import cn.datapilot.web.util.JWTUtils;
import cn.datapilot.web.util.MD5Utils;
...
public class LoginServiceImpl implements LoginService {
    ...
    @Value("${dp.auth.jwt.issuer:data-pilot}")
